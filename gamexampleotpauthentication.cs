...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Insira o código OTP para fazer login") ;
      ...
      {
         return "Insira o código OTP para fazer login" ;
      }
      ...
      protected void WB0Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, "Usuário", "col-xs-12 AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, "Código OTP", "col-xs-12 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 19,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV15UserPassword), StringUtil.RTrim( context.localUtil.Format( AV15UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Código", edtavUserpassword_Jsonclick, 0, "Attribute", "", "", "", "", edtavUserpassword_Visible, edtavUserpassword_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnter_Internalname, "", "Validar código", bttEnter_Jsonclick, 5, "Validar código", "", StyleString, ClassString, bttEnter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttLogin_Internalname, "", "Voltar ao Login", bttLogin_Jsonclick, 5, "Voltar ao Login", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'LOGIN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0Y2( )
      {
         ...
         Form.Meta.addItem("description", "Insira o código OTP para fazer login", 0) ;
         context.wjLoc = "";
      ...
      protected void E110Y2( )
      {
         ...
         else
         {
            ...
            {
               GX_msglist.addItem("O código de acesso do usuário foi enviado.");
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482519412311", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?202482519412314", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120Y2","iparms":[{"av":"AV7AuthenticationTypeName","fld":"vAUTHENTICATIONTYPENAME","hsh":true},{"av":"AV16UseTwoFactorAuthentication","fld":"vUSETWOFACTORAUTHENTICATION","hsh":true},{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV14UserName","fld":"vUSERNAME","hsh":true},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]}""");
         setEventMetadata("'LOGIN'","""{"handler":"E130Y2","iparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"}]""");
