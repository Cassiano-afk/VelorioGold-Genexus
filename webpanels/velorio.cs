...
namespace GeneXus.Programs.webpanels {
   public class velorio : GXDataArea
   {
      public velorio( )
      {
      ...
      public velorio( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("webpanels.velorio.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV5IdCidade,4,0))}, new string[] {"IdCidade"}) +"\">") ;
      ...
      {
         return formatLink("webpanels.velorio.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV5IdCidade,4,0))}, new string[] {"IdCidade"})  ;
      }

      public override string GetPgmname( )
      {
         return "WebPanels.Velorio" ;
      }
      ...
      protected void RF182( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A64IdCidade = H00182_A64IdCidade[0];
               A58HoraFim = H00182_A58HoraFim[0];
               A57HoraInicio = H00182_A57HoraInicio[0];
               A2Nome = H00182_A2Nome[0];
               /* Execute user event: Load */
               E11182 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248221056046", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("webpanels/velorio.js", "?20248221056046", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'ACESSAR CERIMÙNIA'","""{"handler":"E12182","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         H00182_A55IdTransmissao = new short[1] ;
         H00182_A64IdCidade = new short[1] ;
         H00182_A58HoraFim = new DateTime[] {DateTime.MinValue} ;
         H00182_A57HoraInicio = new DateTime[] {DateTime.MinValue} ;
         H00182_A2Nome = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.webpanels.velorio__default(),
            new Object[][] {
                new Object[] {
               H00182_A55IdTransmissao, H00182_A64IdCidade, H00182_A58HoraFim, H00182_A57HoraInicio, H00182_A2Nome
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H00182_A55IdTransmissao ;
      private short[] H00182_A64IdCidade ;
      private DateTime[] H00182_A58HoraFim ;
      private DateTime[] H00182_A57HoraInicio ;
      private string[] H00182_A2Nome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class velorio__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00182", "SELECT [IdTransmissao], [IdCidade], [HoraFim], [HoraInicio], [Nome] FROM [GerenciadorDeTransmissoes] WHERE [IdCidade] = @AV5IdCidade ORDER BY [IdTransmissao] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00182,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
