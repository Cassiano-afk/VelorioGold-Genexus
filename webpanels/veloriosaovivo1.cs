...
namespace GeneXus.Programs.webpanels {
   public class veloriosaovivo1 : GXDataArea
   {
      public veloriosaovivo1( )
      {
      ...
      public veloriosaovivo1( IGxContext context )
      {
      ...
      public void execute( short aP0_IdCidade ,
                           ref DateTime aP1_HoraInicio ,
                           ref DateTime aP2_HoraFim )
      {
         this.AV5IdCidade = aP0_IdCidade;
         this.AV7HoraInicio = aP1_HoraInicio;
         this.AV8HoraFim = aP2_HoraFim;
         ExecuteImpl();
         aP1_HoraInicio=this.AV7HoraInicio;
         aP2_HoraFim=this.AV8HoraFim;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV7HoraInicio = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "HoraInicio")));
                  AssignAttri("", false, "AV7HoraInicio", context.localUtil.TToC( AV7HoraInicio, 0, 5, 0, 3, "/", ":", " "));
                  AV8HoraFim = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "HoraFim")));
                  AssignAttri("", false, "AV8HoraFim", context.localUtil.TToC( AV8HoraFim, 0, 5, 0, 3, "/", ":", " "));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("webpanels.veloriosaovivo1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV5IdCidade,4,0)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV7HoraInicio)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV8HoraFim))}, new string[] {"IdCidade","HoraInicio","HoraFim"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vHORAINICIO", context.localUtil.TToC( AV7HoraInicio, 10, 8, 0, 0, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "vHORAFIM", context.localUtil.TToC( AV8HoraFim, 10, 8, 0, 0, "/", ":", " "));
      }
      ...
      {
         return formatLink("webpanels.veloriosaovivo1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV5IdCidade,4,0)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV7HoraInicio)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV8HoraFim))}, new string[] {"IdCidade","HoraInicio","HoraFim"})  ;
      }

      public override string GetPgmname( )
      {
         return "WebPanels.VeloriosAoVivo1" ;
      }

      public override string GetPgmdesc( )
      {
         return "CÍrimonias Disponiveis" ;
      }
      ...
      protected void START0S2( )
      {
         ...
         Form.Meta.addItem("description", "CÍrimonias Disponiveis", 0) ;
         context.wjLoc = "";
      ...
      protected void gxgrGrid1_refresh( short AV5IdCidade )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A64IdCidade = H000S2_A64IdCidade[0];
               A58HoraFim = H000S2_A58HoraFim[0];
               A57HoraInicio = H000S2_A57HoraInicio[0];
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV5IdCidade", StringUtil.LTrimStr( (decimal)(AV5IdCidade), 4, 0));
         AV7HoraInicio = (DateTime)getParm(obj,1);
         AssignAttri("", false, "AV7HoraInicio", context.localUtil.TToC( AV7HoraInicio, 0, 5, 0, 3, "/", ":", " "));
         AV8HoraFim = (DateTime)getParm(obj,2);
         AssignAttri("", false, "AV8HoraFim", context.localUtil.TToC( AV8HoraFim, 0, 5, 0, 3, "/", ":", " "));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248218395527", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("webpanels/veloriosaovivo1.js", "?20248218395527", false, true);
      ...
      protected void sendrow_62( )
      {
         ...
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"form-group gx-form-group",(string)"start",(string)"top",(string)""+" data-gx-for=\""+edtHoraInicio_Internalname+"\"",(string)"",(string)"div"});
         /* Attribute/Variable Label */
         Grid1Row.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtHoraInicio_Internalname,(string)"Horario de InÌcio",(string)"col-sm-3 AttributeLabel",(short)1,(bool)true,(string)""});
         /* Div Control */
         ...
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"form-group gx-form-group",(string)"start",(string)"top",(string)""+" data-gx-for=\""+edtHoraFim_Internalname+"\"",(string)"",(string)"div"});
         /* Attribute/Variable Label */
         Grid1Row.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtHoraFim_Internalname,(string)"Horario Fim",(string)"col-sm-3 AttributeLabel",(short)1,(bool)true,(string)""});
         /* Div Control */
         Grid1Row.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-sm-9 gx-attribute",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Single line edit */
         ROClassString = "Attribute";
         ...
         ClassString = "ButtonAcessoVelorioPopUp";
         StyleString = "";
         Grid1Row.AddColumnProperties("button", 2, isAjaxCallMode( ), new Object[] {(string)bttChamatransmissao_Internalname+"_"+sGXsfl_6_idx,"gx.evt.setGridEvt("+StringUtil.Str( (decimal)(6), 1, 0)+","+"null"+");",(string)"Acessar CerimÙnia",(string)bttChamatransmissao_Jsonclick,(short)7,(string)"Acessar CerimÙnia",(string)"",(string)StyleString,(string)ClassString,(short)1,(short)1,(string)"standard",(string)"'"+""+"'"+",false,"+"'"+"e120s2_client"+"'",(string)TempTags,(string)"",(short)2});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Grid1Row.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
      ...
      protected void StartGridControl6( )
      {
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            sStyleString = "";
            GxWebStd.gx_table_start( context, subGrid1_Internalname, subGrid1_Internalname, " "+"sdsmartgrid_scrolldirection=\"vertical\""+" "+"sdsmartgrid_multipleitems=\"single\""+" ", "", 0, "", "", 1, 2, sStyleString, "", "", 0);
            Grid1Container.AddObjectProperty("GridName", "Grid1");
         }
         else
         {
      ...
      protected void init_default_properties( )
      {
         ...
         bttChamatransmissao_Internalname = "CHAMATRANSMISSAO";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "CÍrimonias Disponiveis";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"AV5IdCidade","fld":"vIDCIDADE","pic":"ZZZ9"}]}""");
         setEventMetadata("'ACESSAR CERIMÙNIA'","""{"handler":"E120S2","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Horafim","iparms":[]}""");
         return  ;
      }
      ...
      {
         wcpOAV7HoraInicio = (DateTime)(DateTime.MinValue);
         wcpOAV8HoraFim = (DateTime)(DateTime.MinValue);
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         FormProcess = "";
         ...
         H000S2_A55IdTransmissao = new short[1] ;
         H000S2_A64IdCidade = new short[1] ;
         H000S2_A58HoraFim = new DateTime[] {DateTime.MinValue} ;
         H000S2_A57HoraInicio = new DateTime[] {DateTime.MinValue} ;
         ...
         ClassString = "";
         StyleString = "";
         bttChamatransmissao_Jsonclick = "";
         subGrid1_Header = "";
         Grid1Column = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.webpanels.veloriosaovivo1__default(),
            new Object[][] {
                new Object[] {
               H000S2_A55IdTransmissao, H000S2_A64IdCidade, H000S2_A58HoraFim, H000S2_A57HoraInicio, H000S2_A2Nome
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string bttChamatransmissao_Internalname ;
      private string bttChamatransmissao_Jsonclick ;
      private string subGrid1_Header ;
      private DateTime AV7HoraInicio ;
      private DateTime AV8HoraFim ;
      private DateTime wcpOAV7HoraInicio ;
      private DateTime wcpOAV8HoraFim ;
      ...
      private DateTime aP1_HoraInicio ;
      private DateTime aP2_HoraFim ;
      private IDataStoreProvider pr_default ;
      private short[] H000S2_A55IdTransmissao ;
      private short[] H000S2_A64IdCidade ;
      private DateTime[] H000S2_A58HoraFim ;
      private DateTime[] H000S2_A57HoraInicio ;
      private string[] H000S2_A2Nome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class veloriosaovivo1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [IdTransmissao], [IdCidade], [HoraFim], [HoraInicio], [Nome] FROM [GerenciadorDeTransmissoes] WHERE [IdCidade] = @AV5IdCidade ORDER BY [IdTransmissao] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
