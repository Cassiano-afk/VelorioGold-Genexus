...
namespace GeneXus.Programs.transactions {
   public class obitos : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Obitos", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_Transactions/Obitos.htm");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_select_Internalname, "", "Selecionar", bttBtn_select_Jsonclick, 5, "Selecionar", "", StyleString, ClassString, bttBtn_select_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtInscricao_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1Inscricao), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A1Inscricao), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInscricao_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtInscricao_Enabled, 1, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtNome_Internalname, A2Nome, StringUtil.RTrim( context.localUtil.Format( A2Nome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNome_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNome_Enabled, 1, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtGrupo_Internalname, StringUtil.RTrim( A3Grupo), StringUtil.RTrim( context.localUtil.Format( A3Grupo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtGrupo_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtGrupo_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtReferencia_Internalname, StringUtil.RTrim( A4Referencia), StringUtil.RTrim( context.localUtil.Format( A4Referencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtReferencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtReferencia_Enabled, 0, "text", "", 7, "chr", 1, "row", 7, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtNumero_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5Numero), 9, 0, ",", "")), StringUtil.LTrim( ((edtNumero_Enabled!=0) ? context.localUtil.Format( (decimal)(A5Numero), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A5Numero), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNumero_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNumero_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtValor_Internalname, StringUtil.LTrim( StringUtil.NToC( A6Valor, 18, 4, ",", "")), StringUtil.LTrim( ((edtValor_Enabled!=0) ? context.localUtil.Format( A6Valor, "ZZZZZZZZZZZZ9.9999") : context.localUtil.Format( A6Valor, "ZZZZZZZZZZZZ9.9999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtValor_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtValor_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtVencimento_Internalname, context.localUtil.TToC( A7Vencimento, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A7Vencimento, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVencimento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtVencimento_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtVencimento_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVencimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtNascimento_Internalname, context.localUtil.Format(A8Nascimento, "99/99/9999"), context.localUtil.Format( A8Nascimento, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNascimento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNascimento_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtNascimento_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtNascimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtFalecimento_Internalname, context.localUtil.Format(A9Falecimento, "99/99/9999"), context.localUtil.Format( A9Falecimento, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFalecimento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtFalecimento_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtFalecimento_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtFalecimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtNumeroObito_Internalname, A10NumeroObito, StringUtil.RTrim( context.localUtil.Format( A10NumeroObito, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNumeroObito_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNumeroObito_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtNFNumero_Internalname, A11NFNumero, StringUtil.RTrim( context.localUtil.Format( A11NFNumero, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNFNumero_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNFNumero_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtNFValor_Internalname, StringUtil.LTrim( StringUtil.NToC( A12NFValor, 18, 4, ",", "")), StringUtil.LTrim( ((edtNFValor_Enabled!=0) ? context.localUtil.Format( A12NFValor, "ZZZZZZZZZZZZ9.9999") : context.localUtil.Format( A12NFValor, "ZZZZZZZZZZZZ9.9999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNFValor_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtNFValor_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtFuneraria_Internalname, StringUtil.RTrim( A13Funeraria), StringUtil.RTrim( context.localUtil.Format( A13Funeraria, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFuneraria_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtFuneraria_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtLote_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A19Lote), 9, 0, ",", "")), StringUtil.LTrim( ((edtLote_Enabled!=0) ? context.localUtil.Format( (decimal)(A19Lote), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A19Lote), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,124);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLote_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLote_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtEnderecoFalecido_Internalname, A22EnderecoFalecido, StringUtil.RTrim( context.localUtil.Format( A22EnderecoFalecido, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,139);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEnderecoFalecido_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtEnderecoFalecido_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edthorafalecimento_Internalname, A23horafalecimento, StringUtil.RTrim( context.localUtil.Format( A23horafalecimento, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,144);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edthorafalecimento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edthorafalecimento_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtDatasolicitacaoAux_Internalname, context.localUtil.TToC( A27DatasolicitacaoAux, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A27DatasolicitacaoAux, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,164);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDatasolicitacaoAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDatasolicitacaoAux_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtDatasolicitacaoAux_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtDatasolicitacaoAux_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtEndContratanteAux_Internalname, A29EndContratanteAux, StringUtil.RTrim( context.localUtil.Format( A29EndContratanteAux, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,174);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEndContratanteAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtEndContratanteAux_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCidadeContratanteAux_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A30CidadeContratanteAux), 9, 0, ",", "")), StringUtil.LTrim( ((edtCidadeContratanteAux_Enabled!=0) ? context.localUtil.Format( (decimal)(A30CidadeContratanteAux), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A30CidadeContratanteAux), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,179);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCidadeContratanteAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCidadeContratanteAux_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtRGContratanteAux_Internalname, A31RGContratanteAux, StringUtil.RTrim( context.localUtil.Format( A31RGContratanteAux, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,184);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRGContratanteAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtRGContratanteAux_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtCPFContratanteAux_Internalname, A32CPFContratanteAux, StringUtil.RTrim( context.localUtil.Format( A32CPFContratanteAux, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,189);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCPFContratanteAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCPFContratanteAux_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtEstCivilContratanteAux_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A33EstCivilContratanteAux), 9, 0, ",", "")), StringUtil.LTrim( ((edtEstCivilContratanteAux_Enabled!=0) ? context.localUtil.Format( (decimal)(A33EstCivilContratanteAux), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A33EstCivilContratanteAux), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,194);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstCivilContratanteAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtEstCivilContratanteAux_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtDataInsert_Internalname, context.localUtil.TToC( A34DataInsert, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A34DataInsert, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,199);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDataInsert_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDataInsert_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtDataInsert_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtDataInsert_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void drawControls1( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtUsuInsert_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A35UsuInsert), 9, 0, ",", "")), StringUtil.LTrim( ((edtUsuInsert_Enabled!=0) ? context.localUtil.Format( (decimal)(A35UsuInsert), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A35UsuInsert), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,204);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuInsert_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtUsuInsert_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtDataUpdate_Internalname, context.localUtil.TToC( A36DataUpdate, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A36DataUpdate, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,209);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDataUpdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDataUpdate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_bitmap( context, edtDataUpdate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtDataUpdate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/Obitos.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtUsuUpdate_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A37UsuUpdate), 9, 0, ",", "")), StringUtil.LTrim( ((edtUsuUpdate_Enabled!=0) ? context.localUtil.Format( (decimal)(A37UsuUpdate), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A37UsuUpdate), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,214);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuUpdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtUsuUpdate_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtValorAux_Internalname, StringUtil.LTrim( StringUtil.NToC( A39ValorAux, 18, 4, ",", "")), StringUtil.LTrim( ((edtValorAux_Enabled!=0) ? context.localUtil.Format( A39ValorAux, "ZZZZZZZZZZZZ9.9999") : context.localUtil.Format( A39ValorAux, "ZZZZZZZZZZZZ9.9999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onblur(this,224);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtValorAux_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtValorAux_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtObservacaoAux_Internalname, A41ObservacaoAux, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,234);\"", 0, 1, edtObservacaoAux_Enabled, 0, 80, "chr", 4, "row", 0, StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtEmCarencia_Internalname, StringUtil.RTrim( A42EmCarencia), StringUtil.RTrim( context.localUtil.Format( A42EmCarencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,239);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmCarencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtEmCarencia_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtRelatoObito_Internalname, A46RelatoObito, A46RelatoObito, TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,259);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRelatoObito_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtRelatoObito_Enabled, 0, "text", "", 16, "chr", 1, "row", 16, 0, 0, 0, 0, 0, -1, true, "", "start", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtViciosHabituais_Internalname, StringUtil.RTrim( A47ViciosHabituais), StringUtil.RTrim( context.localUtil.Format( A47ViciosHabituais, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,264);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtViciosHabituais_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtViciosHabituais_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtViciosEspecificar_Internalname, A48ViciosEspecificar, StringUtil.RTrim( context.localUtil.Format( A48ViciosEspecificar, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,269);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtViciosEspecificar_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtViciosEspecificar_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtTaxaSepultamento_Internalname, StringUtil.LTrim( StringUtil.NToC( A51TaxaSepultamento, 18, 4, ",", "")), StringUtil.LTrim( ((edtTaxaSepultamento_Enabled!=0) ? context.localUtil.Format( A51TaxaSepultamento, "ZZZZZZZZZZZZ9.9999") : context.localUtil.Format( A51TaxaSepultamento, "ZZZZZZZZZZZZ9.9999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','4');"+";gx.evt.onblur(this,284);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTaxaSepultamento_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTaxaSepultamento_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSeq_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A54Seq), 9, 0, ",", "")), StringUtil.LTrim( ((edtSeq_Enabled!=0) ? context.localUtil.Format( (decimal)(A54Seq), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A54Seq), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,299);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSeq_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSeq_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_enter_Internalname, "", "Confirmar", bttBtn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "Button button-tertiary";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_delete_Internalname, "", "Eliminar", bttBtn_delete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/Obitos.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z8Nascimento = context.localUtil.CToD( cgiGet( "Z8Nascimento"), 0);
               n8Nascimento = ((DateTime.MinValue==A8Nascimento) ? true : false);
               Z9Falecimento = context.localUtil.CToD( cgiGet( "Z9Falecimento"), 0);
               ...
               n7Vencimento = ((DateTime.MinValue==A7Vencimento) ? true : false);
               if ( context.localUtil.VCDate( cgiGet( edtNascimento_Internalname), 2) == 0 )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Nascimento"}), 1, "NASCIMENTO");
                  AnyError = 1;
               ...
               n8Nascimento = ((DateTime.MinValue==A8Nascimento) ? true : false);
               if ( context.localUtil.VCDate( cgiGet( edtFalecimento_Internalname), 2) == 0 )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Falecimento"}), 1, "FALECIMENTO");
                  AnyError = 1;
               ...
               {
                  GXUtil.WriteLogError("transactions\\obitos:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
                  GxWebError = 1;
      ...
      protected void E12012( )
      {
         ...
         {
            CallWebObject(formatLink("transactions.wwobitos.aspx") );
            context.wjLocDisableFrm = 1;
         }
      ...
      protected void standaloneModal( )
      {
         ...
         {
            AV12Pgmname = "Transactions.Obitos";
      ...
      protected void CheckExtendedTable011( )
      {
         ...
         if ( ! ( (DateTime.MinValue==A8Nascimento) || ( DateTimeUtil.ResetTime ( A8Nascimento ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
         ...
         if ( ! ( (DateTime.MinValue==A9Falecimento) || ( DateTimeUtil.ResetTime ( A9Falecimento ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
      ...
      protected void CheckOptimisticConcurrency011( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( DateTimeUtil.ResetTime ( Z8Nascimento ) != DateTimeUtil.ResetTime ( T00012_A8Nascimento[0] ) ) || ( DateTimeUtil.ResetTime ( Z9Falecimento ) != DateTimeUtil.ResetTime ( T00012_A9Falecimento[0] ) ) || ( StringUtil.StrCmp(Z10NumeroObito, T00012_A10NumeroObito[0]) != 0 ) || ( StringUtil.StrCmp(Z11NFNumero, T00012_A11NFNumero[0]) != 0 ) || ( Z12NFValor != T00012_A12NFValor[0] ) )
            {
               Gx_longc = true;
            }
            ...
            if ( Gx_longc || ( Z54Seq != T00012_A54Seq[0] ) )
            {
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Grupo");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Referencia");
                  GXUtil.WriteLogRaw("Old: ",Z4Referencia);
                  GXUtil.WriteLogRaw("Current: ",T00012_A4Referencia[0]);
               }
               if ( Z5Numero != T00012_A5Numero[0] )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Numero");
                  GXUtil.WriteLogRaw("Old: ",Z5Numero);
                  GXUtil.WriteLogRaw("Current: ",T00012_A5Numero[0]);
               }
               if ( Z6Valor != T00012_A6Valor[0] )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Valor");
                  GXUtil.WriteLogRaw("Old: ",Z6Valor);
                  GXUtil.WriteLogRaw("Current: ",T00012_A6Valor[0]);
               }
               if ( Z7Vencimento != T00012_A7Vencimento[0] )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Vencimento");
                  GXUtil.WriteLogRaw("Old: ",Z7Vencimento);
                  GXUtil.WriteLogRaw("Current: ",T00012_A7Vencimento[0]);
               }
               if ( DateTimeUtil.ResetTime ( Z8Nascimento ) != DateTimeUtil.ResetTime ( T00012_A8Nascimento[0] ) )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Nascimento");
                  GXUtil.WriteLogRaw("Old: ",Z8Nascimento);
                  GXUtil.WriteLogRaw("Current: ",T00012_A8Nascimento[0]);
               }
               if ( DateTimeUtil.ResetTime ( Z9Falecimento ) != DateTimeUtil.ResetTime ( T00012_A9Falecimento[0] ) )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Falecimento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"NumeroObito");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"NFNumero");
                  GXUtil.WriteLogRaw("Old: ",Z11NFNumero);
                  GXUtil.WriteLogRaw("Current: ",T00012_A11NFNumero[0]);
               }
               if ( Z12NFValor != T00012_A12NFValor[0] )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"NFValor");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Funeraria");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Observacao");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Parentesco");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Capela");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"EnderecoFalecido");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"horafalecimento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"CidadeFalecimento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"LocalFalecimento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"HoraSepultamento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"DatasolicitacaoAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"NomeContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"EndContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"CidadeContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"RGContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"CPFContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"EstCivilContratanteAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"DataInsert");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"UsuInsert");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"DataUpdate");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"UsuUpdate");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"NumControleAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"ValorAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"DataPagtoAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"ObservacaoAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"EmCarencia");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"PercentualCobertura");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"PacienteUnesp");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"RegistroUnesp");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"ViciosHabituais");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"ViciosEspecificar");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"DoencasConhecidas");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"TaxaCapelaAux");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"TaxaSepultamento");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Matricula");
               ...
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"UsouCremacao");
                  GXUtil.WriteLogRaw("Old: ",Z53UsouCremacao);
                  GXUtil.WriteLogRaw("Current: ",T00012_A53UsouCremacao[0]);
               }
               if ( Z54Seq != T00012_A54Seq[0] )
               {
                  GXUtil.WriteLog("transactions.obitos:[seudo value changed for attri]"+"Seq");
      ...
      protected void OnDeleteControls011( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(0, new Object[] {A1Inscricao, A2Nome});
      ...
      protected void EndLevel011( )
      {
         ...
         {
            pr_datastore1.close(1);
            context.CommitDataStores("transactions.obitos",pr_default);
            if ( AnyError == 0 )
            {
               ConfirmValues010( ) ;
            }
         ...
         {
            pr_datastore1.close(1);
            context.RollbackDataStores("transactions.obitos",pr_default);
         }
         IsModified = 0;
         if ( AnyError != 0 )
         {
      ...
      public void ScanStart011( )
      {
         ...
         {
            RcdFound1 = 1;
            A1Inscricao = T000112_A1Inscricao[0];
            AssignAttri("", false, "A1Inscricao", StringUtil.LTrimStr( (decimal)(A1Inscricao), 9, 0));
            A2Nome = T000112_A2Nome[0];
            AssignAttri("", false, "A2Nome", A2Nome);
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("transactions\\obitos:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z8Nascimento", context.localUtil.DToC( Z8Nascimento, 0, "/"));
         GxWebStd.gx_hidden_field( context, "Z9Falecimento", context.localUtil.DToC( Z9Falecimento, 0, "/"));
      ...
      {
         return formatLink("transactions.obitos.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV7Inscricao,9,0)),UrlEncode(StringUtil.RTrim(AV8Nome))}, new string[] {"Gx_mode","Inscricao","Nome"})  ;
      }

      public override string GetPgmname( )
      {
         return "Transactions.Obitos" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482519405535", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("transactions/obitos.js", "?202482519405535", false, true);
      ...
      public override void initialize( )
      {
         ...
         T000111_A55IdTransmissao = new short[1] ;
         T000112_A1Inscricao = new int[1] ;
         T000112_A2Nome = new string[] {""} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.transactions.obitos__gam(),
            new Object[][] {
            }
         );
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.transactions.obitos__datastore1(),
            new Object[][] {
                new Object[] {
               ...
               , new Object[] {
               T000112_A1Inscricao, T000112_A2Nome
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.transactions.obitos__default(),
            new Object[][] {
                new Object[] {
               T000111_A55IdTransmissao
               }
            }
         );
         AV12Pgmname = "Transactions.Obitos";
      ...
      private short[] T000111_A55IdTransmissao ;
      private int[] T000112_A1Inscricao ;
      private string[] T000112_A2Nome ;
      private IDataStoreProvider pr_gam ;
   }

   public class obitos__gam : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class obitos__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new ParDef("@Nascimento",GXType.Date,8,0){Nullable=true} ,
        new ParDef("@Falecimento",GXType.Date,8,0){Nullable=true} ,
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000112", "SELECT [Inscricao], [Nome] FROM dbo.[Obitos] ORDER BY [Inscricao], [Nome]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000112,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
...
public class obitos__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("T000111", "SELECT TOP 1 [IdTransmissao] FROM [GerenciadorDeTransmissoes] WHERE [Inscricao] = @Inscricao AND [Nome] = @Nome ",true, GxErrorMask.GX_NOMASK, false, this,prmT000111,1, GxCacheFrequency.OFF ,true,true )
       };
    }
 }
