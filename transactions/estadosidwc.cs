...
namespace GeneXus.Programs.transactions {
   public class estadosidwc : GXWebComponent
   {
      public estadosidwc( )
      {
      ...
      public estadosidwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IdEstado = (short)(Math.Round(NumberUtil.Val( GetPar( "IdEstado"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6IdEstado, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV13Pgmname = "Transactions.EstadosIdWC";
               WS0A2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Estados Id WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("transactions.estadosidwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IdEstado,4,0))}, new string[] {"IdEstado"}) +"\">") ;
      ...
      {
         return "Transactions.EstadosIdWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Estados Id WC" ;
      }
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "transactions.estadosidwc.aspx");
            }
            /* Div Control */
         ...
         if ( wbEnd == 15 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIdEstado_Internalname, "Id Estado", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'" + sPrefix + "',false,'" + sGXsfl_15_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtIdEstado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A61IdEstado), 4, 0, ",", "")), StringUtil.LTrim( ((edtIdEstado_Enabled!=0) ? context.localUtil.Format( (decimal)(A61IdEstado), "ZZZ9") : context.localUtil.Format( (decimal)(A61IdEstado), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,21);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIdEstado_Jsonclick, 0, "Attribute", "", "", "", "", edtIdEstado_Visible, edtIdEstado_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Transactions\\Id", "end", false, "", "HLP_Transactions/EstadosIdWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Estados Id WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A61IdEstado = H000A2_A61IdEstado[0];
               AssignAttri(sPrefix, false, "A61IdEstado", StringUtil.LTrimStr( (decimal)(A61IdEstado), 4, 0));
               A65NomeCidade = H000A2_A65NomeCidade[0];
               A64IdCidade = H000A2_A64IdCidade[0];
               /* Execute user event: Grid.Load */
               E120A2 ();
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IdEstado = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IdEstado"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Transactions.Estados";
         AV11TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "IdEstado";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IdEstado), 4, 0);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "transactions\\estadosidwc", GetJustCreated( ));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6IdEstado = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6IdEstado), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6IdEstado", StringUtil.LTrimStr( (decimal)(AV6IdEstado), 4, 0));
         }
         else
         {
            AV6IdEstado = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6IdEstado_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482519404147", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("transactions/estadosidwc.js", "?202482519404149", false, true);
         }
      ...
      {
         edtIdCidade_Internalname = sPrefix+"IDCIDADE_"+sGXsfl_15_idx;
         edtNomeCidade_Internalname = sPrefix+"NOMECIDADE_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtIdCidade_Internalname = sPrefix+"IDCIDADE_"+sGXsfl_15_fel_idx;
         edtNomeCidade_Internalname = sPrefix+"NOMECIDADE_"+sGXsfl_15_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6IdEstado","fld":"vIDESTADO","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E120A2","iparms":[]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6IdEstado","fld":"vIDESTADO","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6IdEstado","fld":"vIDESTADO","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6IdEstado","fld":"vIDESTADO","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6IdEstado","fld":"vIDESTADO","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         A65NomeCidade = "";
         H000A2_A61IdEstado = new short[1] ;
         H000A2_A65NomeCidade = new string[] {""} ;
         H000A2_A64IdCidade = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.transactions.estadosidwc__default(),
            new Object[][] {
                new Object[] {
               H000A2_A61IdEstado, H000A2_A65NomeCidade, H000A2_A64IdCidade
               }
               , new Object[] {
      ...
      private short[] H000A2_A61IdEstado ;
      private string[] H000A2_A65NomeCidade ;
      private short[] H000A2_A64IdCidade ;
   ...
   public class estadosidwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6IdEstado",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "SELECT [IdEstado], [NomeCidade], [IdCidade] FROM [EstadosId] WHERE [IdEstado] = @AV6IdEstado ORDER BY [IdEstado]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000A3", "SELECT COUNT(*) FROM [EstadosId] WHERE [IdEstado] = @AV6IdEstado ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
