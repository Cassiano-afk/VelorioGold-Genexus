...
namespace GeneXus.Programs.transactions {
   public class wwestados : GXDataArea
   {
      public wwestados( )
      {
      ...
      public wwestados( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11NomeEstado = GetPar( "NomeEstado");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11NomeEstado, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("transactions.wwestados.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMEESTADO", StringUtil.RTrim( AV11NomeEstado));
         /* Send saved values. */
      ...
      {
         return formatLink("transactions.wwestados.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Transactions.WWEstados" ;
      }
      ...
      protected void WB080( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Estadoss", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_Transactions/WWEstados.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Transactions/WWEstados.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavNomeestado_Internalname, "Nome Estado", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavNomeestado_Internalname, StringUtil.RTrim( AV11NomeEstado), StringUtil.RTrim( context.localUtil.Format( AV11NomeEstado, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Estado", edtavNomeestado_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavNomeestado_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Transactions/WWEstados.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START082( )
      {
         ...
         Form.Meta.addItem("description", "Estadoss", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Nomeestado Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMEESTADO"), AV11NomeEstado) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA082( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavNomeestado_Internalname;
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "Transactions.WWEstados";
      ...
      protected void RF082( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11NomeEstado = StringUtil.PadR( StringUtil.RTrim( AV11NomeEstado), 2, "%");
            /* Using cursor H00082 */
            pr_default.execute(0, new Object[] {lV11NomeEstado, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A63EstadoLL = H00082_A63EstadoLL[0];
               A62NomeEstado = H00082_A62NomeEstado[0];
               A61IdEstado = H00082_A61IdEstado[0];
               /* Execute user event: Grid.Load */
               E14082 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDESTADO"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A61IdEstado), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11NomeEstado = StringUtil.PadR( StringUtil.RTrim( AV11NomeEstado), 2, "%");
         /* Using cursor H00083 */
         pr_default.execute(1, new Object[] {lV11NomeEstado});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11NomeEstado = GridState.FilterValues("Nomeestado");
            AssignAttri("", false, "AV11NomeEstado", AV11NomeEstado);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("NomeEstado", AV11NomeEstado);
      }
      ...
      protected void STRUP080( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11NomeEstado = cgiGet( edtavNomeestado_Internalname);
            AssignAttri("", false, "AV11NomeEstado", AV11NomeEstado);
      ...
      private void E14082( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("transactions.estados.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A61IdEstado,4,0))}, new string[] {"Mode","IdEstado"}) ;
         edtavDelete_Link = formatLink("transactions.estados.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A61IdEstado,4,0))}, new string[] {"Mode","IdEstado"}) ;
      ...
      protected void E11082( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("transactions.estados.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","IdEstado"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Transactions.Estados";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248251941589", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("transactions/wwestados.js", "?20248251941589", false, true);
         }
      ...
      {
         edtIdEstado_Internalname = "IDESTADO_"+sGXsfl_27_idx;
         edtNomeEstado_Internalname = "NOMEESTADO_"+sGXsfl_27_idx;
         edtEstadoLL_Internalname = "ESTADOLL_"+sGXsfl_27_idx;
      ...
      {
         edtIdEstado_Internalname = "IDESTADO_"+sGXsfl_27_fel_idx;
         edtNomeEstado_Internalname = "NOMEESTADO_"+sGXsfl_27_fel_idx;
         edtEstadoLL_Internalname = "ESTADOLL_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNomeEstado_Internalname,StringUtil.RTrim( A62NomeEstado),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtNomeEstado_Link,(string)"",(string)"",(string)"",(string)edtNomeEstado_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)2,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A63EstadoLL), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavNomeestado_Internalname = "vNOMEESTADO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtNomeEstado_Enabled = 0;
         edtIdEstado_Enabled = 0;
         edtavNomeestado_Jsonclick = "";
         edtavNomeestado_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11NomeEstado","fld":"vNOMEESTADO"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E14082","iparms":[{"av":"A61IdEstado","fld":"IDESTADO","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtNomeEstado_Link","ctrl":"NOMEESTADO","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E11082","iparms":[{"av":"A61IdEstado","fld":"IDESTADO","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11NomeEstado","fld":"vNOMEESTADO"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11NomeEstado","fld":"vNOMEESTADO"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11NomeEstado","fld":"vNOMEESTADO"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11NomeEstado","fld":"vNOMEESTADO"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11NomeEstado = "";
         H00082_A63EstadoLL = new short[1] ;
         H00082_A62NomeEstado = new string[] {""} ;
         H00082_A61IdEstado = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.transactions.wwestados__default(),
            new Object[][] {
                new Object[] {
               H00082_A63EstadoLL, H00082_A62NomeEstado, H00082_A61IdEstado
               }
               , new Object[] {
      ...
      private int edtavNomeestado_Enabled ;
      ...
      private string edtavNomeestado_Internalname ;
      private string edtavNomeestado_Jsonclick ;
      ...
      private short[] H00082_A63EstadoLL ;
      private string[] H00082_A62NomeEstado ;
      private short[] H00082_A61IdEstado ;
   ...
   public class wwestados__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A62NomeEstado )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NomeEstado)) )
         {
            AddWhere(sWhereString, "([NomeEstado] like @lV11NomeEstado)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [NomeEstado]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11NomeEstado",GXType.NChar,2,0) ,
