...
namespace GeneXus.Programs.transactions {
   public class viewgerenciadordetransmissoes : GXDataArea
   {
      public viewgerenciadordetransmissoes( )
      {
      ...
      public viewgerenciadordetransmissoes( IGxContext context )
      {
      ...
      public void execute( short aP0_IdTransmissao ,
                           string aP1_TabCode )
      {
         this.AV12IdTransmissao = aP0_IdTransmissao;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IdTransmissao = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12IdTransmissao", StringUtil.LTrimStr( (decimal)(AV12IdTransmissao), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDTRANSMISSAO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IdTransmissao), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("transactions.viewgerenciadordetransmissoes.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IdTransmissao,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IdTransmissao","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vIDTRANSMISSAO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IdTransmissao), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDTRANSMISSAO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IdTransmissao), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewGerenciadorDeTransmissoes");
         forbiddenHiddens.Add("DataVelorio", context.localUtil.Format(A56DataVelorio, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("transactions\\viewgerenciadordetransmissoes:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("transactions.viewgerenciadordetransmissoes.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IdTransmissao,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IdTransmissao","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "Transactions.ViewGerenciadorDeTransmissoes" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Gerenciador De Transmissoes" ;
      }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Gerenciador De Transmissões | Velório Golds", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_Transactions/ViewGerenciadorDeTransmissoes.htm");
            ...
            GxWebStd.gx_label_element( context, edtDataVelorio_Internalname, "Velorio", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtDataVelorio_Internalname, context.localUtil.Format(A56DataVelorio, "99/99/99"), context.localUtil.Format( A56DataVelorio, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDataVelorio_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtDataVelorio_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Transactions/ViewGerenciadorDeTransmissoes.htm");
            GxWebStd.gx_bitmap( context, edtDataVelorio_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtDataVelorio_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Transactions/ViewGerenciadorDeTransmissoes.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Transactions/ViewGerenciadorDeTransmissoes.htm");
            /* Div Control */
      ...
      protected void START0B2( )
      {
         ...
         Form.Meta.addItem("description", "View Gerenciador De Transmissoes", 0) ;
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV13Pgmname = "Transactions.ViewGerenciadorDeTransmissoes";
      }
      ...
      protected void RF0B2( )
      {
         ...
         {
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {AV12IdTransmissao});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A55IdTransmissao = H000B2_A55IdTransmissao[0];
               A56DataVelorio = H000B2_A56DataVelorio[0];
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IdTransmissao = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vIDTRANSMISSAO"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("transactions\\viewgerenciadordetransmissoes:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110B2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV12IdTransmissao});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A55IdTransmissao = H000B3_A55IdTransmissao[0];
            A56DataVelorio = H000B3_A56DataVelorio[0];
            AssignAttri("", false, "A56DataVelorio", context.localUtil.Format(A56DataVelorio, "99/99/99"));
            AV14GXLvl7 = 1;
            Form.Caption = context.localUtil.DToC( A56DataVelorio, 2, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("transactions.wwgerenciadordetransmissoes.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Transactions.GerenciadorDeTransmissoesGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "transactions.gerenciadordetransmissoesgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Transactions.GerenciadorDeTransmissoesGeneral";
               WebComp_Generalwc_Component = "Transactions.GerenciadorDeTransmissoesGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12IdTransmissao});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IdTransmissao = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12IdTransmissao", StringUtil.LTrimStr( (decimal)(AV12IdTransmissao), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDTRANSMISSAO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IdTransmissao), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248251941960", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("transactions/viewgerenciadordetransmissoes.js", "?20248251941960", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Gerenciador De Transmissoes";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12IdTransmissao","fld":"vIDTRANSMISSAO","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A56DataVelorio","fld":"DATAVELORIO"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000B2_A55IdTransmissao = new short[1] ;
         H000B2_A56DataVelorio = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000B3_A55IdTransmissao = new short[1] ;
         H000B3_A56DataVelorio = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.transactions.viewgerenciadordetransmissoes__default(),
            new Object[][] {
                new Object[] {
               H000B2_A55IdTransmissao, H000B2_A56DataVelorio
               }
               , new Object[] {
               H000B3_A55IdTransmissao, H000B3_A56DataVelorio
               }
            }
         );
      ...
      private short AV12IdTransmissao ;
      private short wcpOAV12IdTransmissao ;
      ...
      private short[] H000B2_A55IdTransmissao ;
      private DateTime[] H000B2_A56DataVelorio ;
      private short[] H000B3_A55IdTransmissao ;
      private DateTime[] H000B3_A56DataVelorio ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewgerenciadordetransmissoes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IdTransmissao",GXType.Int16,4,0)
          };
          Object[] prmH000B3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [IdTransmissao], [DataVelorio] FROM [GerenciadorDeTransmissoes] WHERE [IdTransmissao] = @AV12IdTransmissao ORDER BY [IdTransmissao] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000B3", "SELECT [IdTransmissao], [DataVelorio] FROM [GerenciadorDeTransmissoes] WHERE [IdTransmissao] = @AV12IdTransmissao ORDER BY [IdTransmissao] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
