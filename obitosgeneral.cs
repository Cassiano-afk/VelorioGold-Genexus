   ...
   public class obitosgeneral : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("obitosgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1Inscricao,9,0)),UrlEncode(StringUtil.RTrim(A2Nome))}, new string[] {"Inscricao","Nome"}) +"\">") ;
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "obitosgeneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 7, "Modifica", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", TempTags, "", 2, "HLP_ObitosGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12051_client"+"'", TempTags, "", 2, "HLP_ObitosGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtNome_Internalname, A2Nome, StringUtil.RTrim( context.localUtil.Format( A2Nome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,23);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtNome_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ObitosGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtNascimento_Internalname, context.localUtil.TToC( A8Nascimento, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A8Nascimento, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,28);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNascimento_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtNascimento_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ObitosGeneral.htm");
            GxWebStd.gx_bitmap( context, edtNascimento_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtNascimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ObitosGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtFalecimento_Internalname, context.localUtil.TToC( A9Falecimento, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A9Falecimento, "99/99/9999 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',8,24,'por',false,0);"+";gx.evt.onblur(this,33);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFalecimento_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtFalecimento_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ObitosGeneral.htm");
            GxWebStd.gx_bitmap( context, edtFalecimento_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtFalecimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ObitosGeneral.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_datastore1.getStatus(0) != 101) )
            {
               ...
               AssignAttri(sPrefix, false, "A9Falecimento", context.localUtil.TToC( A9Falecimento, 10, 8, 0, 3, "/", ":", " "));
               A8Nascimento = H00052_A8Nascimento[0];
               n8Nascimento = H00052_n8Nascimento[0];
               AssignAttri(sPrefix, false, "A8Nascimento", context.localUtil.TToC( A8Nascimento, 10, 8, 0, 3, "/", ":", " "));
               /* Execute user event: Load */
               E14052 ();
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "Obitos";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "obitosgeneral", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247248541631", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("obitosgeneral.js", "?20247248541632", false, true);
      ...
      public override void initialize( )
      {
         ...
         sCtrlA1Inscricao = "";
         sCtrlA2Nome = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.obitosgeneral__datastore1(),
            new Object[][] {
                new Object[] {
