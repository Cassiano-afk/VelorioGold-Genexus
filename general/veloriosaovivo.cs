...
namespace GeneXus.Programs.general {
   public class veloriosaovivo : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( AV5AcessarCerimonia) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("general.veloriosaovivo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IdCidade,4,0))}, new string[] {"IdCidade"}) +"\">") ;
      ...
      {
         return formatLink("general.veloriosaovivo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IdCidade,4,0))}, new string[] {"IdCidade"})  ;
      }

      public override string GetPgmname( )
      {
         return "General.VeloriosAoVivo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Velorios Ao Vivo" ;
      }
      ...
      protected void START0N2( )
      {
         ...
         Form.Meta.addItem("description", "Velorios Ao Vivo", 0) ;
         context.wjLoc = "";
      ...
      protected void gxgrGrid1_refresh( string AV5AcessarCerimonia )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247241123423", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("general/veloriosaovivo.js", "?20247241123423", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"AV5AcessarCerimonia","fld":"vACESSARCERIMONIA"}]}""");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.general.veloriosaovivo__default(),
            new Object[][] {
                new Object[] {
               H000N2_A55IdTransmissao, H000N2_A58HoraFim, H000N2_A57HoraInicio, H000N2_A2Nome
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class veloriosaovivo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000N2", "SELECT [IdTransmissao], [HoraFim], [HoraInicio], [Nome] FROM [GerenciadorDeTransmissoes] ORDER BY [IdTransmissao] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N2,11, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
