...
namespace GeneXus.Programs.general.ui {
   public class sidebaritemsdp : GXProcedure
   {
      ...
      {
         AV5wwProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "GoldLegacy");
         GXt_objcol_SdtProgramNames_ProgramName1 = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "GoldLegacy");
