...
namespace GeneXus.Programs.general.ui {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "GoldLegacy") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "GoldLegacy");
         AV11name = "Transactions.WWGerenciadorDeTransmissoes";
         AV12description = "Gerenciador De Transmissões";
         AV13link = formatLink("transactions.wwgerenciadordetransmissoes.aspx") ;
         ...
         AV11name = "Transactions.WWObitos";
         AV12description = "Visualizador de Óbitos";
         AV13link = formatLink("transactions.wwobitos.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
